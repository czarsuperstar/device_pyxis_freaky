...
Return<bool> Gnss::injectTime(int64_t __attribute__ ((unused)) timeMs, int64_t __attribute__ ((unused)) timeReferenceMs,
                              int32_t __attribute__ ((unused)) uncertaintyMs) {
    return true;
}
